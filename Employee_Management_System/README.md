...
## 🌟 Features
- **Secure Authentication**: Admin login portal.
- **Employee CRUD**: View employees joined with department details.
- **Reporting**: Export employee lists to CSV natively.
...
2. **Business Logic Layer (Service)**: `AuthService`, `EmployeeService`. Validates and applies rules.
